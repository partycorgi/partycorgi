export const meta = { title: 'Code of Conduct' }

import Hero from './src/components/Layout/Hero.js'
import MaxWidth from './src/components/Layout/MaxWidth.js'
import { Heading } from './src/components/Typography.js'

<Hero className='items-start justify-center md:h-[382px]'>
  <Heading className='text-gray-900'>Code of Conduct</Heading>
</Hero>
<div className='mx-5'>
<MaxWidth className='bg-gray-700 py-12 px-5 rounded-lg transform -translate-y-24'>
...
- If this doesn’t happen, or if you’re uncomfortable speaking up, contact admins by emailing [mods@partycorgi.com](mailto:mods@partycorgi.com).
